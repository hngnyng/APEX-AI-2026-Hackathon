...
export const demoProfiles = {
  sarah: {
    profile: {
      ...
      primaryGoal: "Secure admission into Ivy League Engineering (Top 1% GPA)",
      sleepHours: 5.5,
      weeklyStudyGoal: 38,
  ...
  alex: {
    profile: {
      ...
      primaryGoal: "Pass the semester without failing, transition to major",
      sleepHours: 8.5,
      weeklyStudyGoal: 10,
  ...
  marcus: {
    profile: {
      ...
      primaryGoal: "Maintain balanced A-/B+ average while leading Track & Field",
      sleepHours: 7.5,
      weeklyStudyGoal: 20,
